...
public class FakeServer extends Thread{
  ...
  Integer numPlayers;
  ArrayList<FakeServerIO> threads;
   ...
   * @param numPlayers: the number of Players in the game
   */
  public FakeServer(Integer numPlayers, ServerSocket server_socket) {
    this.server_socket = server_socket;
    this.numPlayers = numPlayers;
    this.threads = new ArrayList<FakeServerIO>();
  ...
  public void run() {
    ...
    while (num <= numPlayers) {
      ...
      try {
        ...
        FakeServerIO serverIO = new FakeServerIO(client_socket, client_socket.getInputStream(),
